...
use anyhow::Result;
use oxilite_compat::check_testsuite;
...
#[test]
#[ignore = "parser-only suite needing the json-ld-api submodule (not vendored); oxilite reuses Oxigraph's parsers"]
...
#[test]
#[ignore = "GeoSPARQL extension functions (spargeo) are out of oxilite's scope"]
