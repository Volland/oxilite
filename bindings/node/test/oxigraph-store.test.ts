// Ported verbatim from oxigraph/js/test/store.test.ts (Oxigraph c11bb740); only the import of Store changed.
import assert from "node:assert";
import { webcrypto } from "node:crypto";
// @ts-expect-error
import dataModel from "@rdfjs/data-model";
import { describe, it, vi } from "vitest";
import { type Quad, Store, type Term } from "../dist/index.js";
